...
import net.lomeli.lomlib.codechicken.lib.lighting.CCRBModel;
import net.lomeli.lomlib.codechicken.lib.lighting.LightModel;
import net.lomeli.lomlib.codechicken.lib.vec.*;

import static net.lomeli.lomlib.codechicken.lib.vec.Rotation.sideRotations;
