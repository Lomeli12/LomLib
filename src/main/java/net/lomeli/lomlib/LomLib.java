...
public class LomLib {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		RecipeSorter.register(Strings.NEI_SHAPED, ShapedFluidRecipe.class,
				RecipeSorter.Category.SHAPED,
				"after:minecraft:shaped before:minecraft:shapeless");
		RecipeSorter.register(Strings.NEI_SHAPELESS,
				ShapelessFluidRecipe.class, RecipeSorter.Category.SHAPELESS,
	...
	public void configureMod(File configFile) {
		...
		debug = config.getBoolean("debugMode", false, Strings.DEBUG_MODE,
				XMLConfiguration.ConfigEnum.GENERAL_CONFIG);
		capes = config.getBoolean("capes", true, Strings.CAPES,
				XMLConfiguration.ConfigEnum.GENERAL_CONFIG);
